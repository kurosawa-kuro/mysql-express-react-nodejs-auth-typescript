...
```
PS C:\Users\kuros\local_dev\full-stack-basic\mysql-express-react-nodejs-auth> pwd

Path
----
C:\Users\kuros\local_dev\full-stack-basic\mysql-express-react-nodejs-auth


PS C:\Users\kuros\local_dev\full-stack-basic\mysql-express-react-nodejs-auth> npx prisma generate --schema=./backend/database/prisma/schema.prisma
```